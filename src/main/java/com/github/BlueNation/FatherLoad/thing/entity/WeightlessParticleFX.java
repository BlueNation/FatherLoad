...
{
    public WeightlessParticleFX(World world, double x, double y, double z, double dX, double dY, double dZ) {
    ...
    public WeightlessParticleFX withRandomGray(){
        particleRed = particleGreen = particleBlue = rand.nextFloat() * 0.3F + 0.7F;
        return this;
    }

    public WeightlessParticleFX withColorTint(float r,float g,float b,float a){
        particleRed=r;
        particleGreen=g;
        particleBlue=b;
        return this;
    ...
    public WeightlessParticleFX withColorTint(float r,float g,float b){
